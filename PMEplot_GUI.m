...
% Last Modified by GUIDE v2.5 19-Dec-2017 11:22:53
...
for i = 1:length(toplot)
    ...
    if showtitle
        PMEplot(folderpath,sampname,xmin,xmax,xres,yres,fig,showMLM,showdot,1-linscale,corespec,sepfig,sampname);
    else
        PMEplot(folderpath,sampname,xmin,xmax,xres,yres,fig,showMLM,showdot,1-linscale,corespec,sepfig);
    end
end
