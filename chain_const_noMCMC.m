%Alex Tye
%Dec 2016
function [pchain, logLk] = chain_const(N_coefs, obs_data, x_min, x_max, p_sig, delta, N_pts)
...
%fileID is the reference to the open log file.
    ...
    [best_coefs, bestLk, hessian, pchain, logLk, accRatio] = pchain_gen(obs_data, knots, priors_mu, cov_prior, N_pts, 0);
